...
public extension ScriptTable {
    ...
    static let ru: ScriptTable = .init(languageCode: "ru", defaultScript: .Cyrl) {[
        ...
        .init([.Latn: "j", .Cyrl: "й", .Glag: "ⰻ"], type: .vowel, prefixContext: .nonConsonant),
        .init([.Latn: "j", .Cyrl: "ь", .Glag: "ⱐ"], type: .vowel, prefixContext: .consonant),
        .init([.Latn: "hj", .Cyrl: "ь", .Glag: "ⱐ"], type: .vowel, prefixContext: .nonConsonant),
