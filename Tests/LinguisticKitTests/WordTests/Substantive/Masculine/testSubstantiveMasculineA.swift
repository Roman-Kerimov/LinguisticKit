//
//  testSubstantiveMasculineA.swift
//
//
...
extension WordTests {
    func testSubstantiveMasculineA() {
        ...
        XCTAssert(
            word: "shúrin",
            forms: SubstantiveForms(
                nominative: ("shúrin", "shúrinyi"),
                genitive: ("shúrina", "shúrinov"),
                dative: ("shúrinu", "shúrinam"),
                accusative: ("shúrina", "shúrinov"),
                instrumental: ("shúrinom", "shúrinami"),
                prepositional: ("shúrine", "shúrinakh")
            )
        )
